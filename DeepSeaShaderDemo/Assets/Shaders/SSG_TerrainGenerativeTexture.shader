...
Shader "SSG_TerrainGenerativeTexture"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 appendResult14 = (float4(ase_vertex3Pos.x , ase_vertex3Pos.z , 0.0 , 0.0));
			float2 uv_TexCoord52 = i.uv_texcoord * float2( 0,0 ) + ( appendResult14 * _OffsetNormal1Scale ).xy;
			float2 uv_TexCoord61 = i.uv_texcoord * float2( 0,0 ) + ( appendResult14 * _OffsetNormal2Scale ).xy;
			...
			float2 uv_TexCoord12 = i.uv_texcoord * float2( 1,1 ) + ( _Albedo1Scale * appendResult14 ).xy;
			float simplePerlin2D10 = snoise( uv_TexCoord12 );
			float clampResult25 = clamp( ( 1.0 - pow( simplePerlin2D10 , 2.0 ) ) , 0.0 , 1.0 );
			float2 uv_TexCoord34 = i.uv_texcoord * float2( 1,1 ) + ( appendResult14 * _Albedo2Scale ).xy;
...
/*ASEBEGIN
Version=15600
2569;-518;1837;1064;3438.739;884.8503;2.015551;True;False
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-3711.441,-207.0899;Float;False;2;2;0;FLOAT;0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;33;-3712.132,241.509;Float;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;63;-1995.798,1243.87;Float;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;51;-1988.043,673.9794;Float;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
...
ASEEND*/
//CHKSM=EBA39E344AD5D143C0B3C03186B29EF9AF9234FE